...
class RoboWorker(AbstractWorker):
...
class Manager:
    ...
    def set_worker(self, worker):
        for e in worker.__class__.__mro__:
            if 'Worker' or 'RoboWorker' in e.__name__:
                self.worker = worker
            else:
